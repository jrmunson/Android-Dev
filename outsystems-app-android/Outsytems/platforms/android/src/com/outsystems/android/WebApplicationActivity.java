...
public class WebApplicationActivity extends BaseActivity implements CordovaInterface {
    ...
    private OnClickListener onClickListenerBack = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (cordovaWebView.canGoBack()) {
                RelativeLayout viewLoading = (RelativeLayout) findViewById(R.id.view_loading);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Config.init(this);
        cordovaWebView.setBackgroundColor(Color.parseColor("#375281"));
        ...
        if (CustomConfiguration.CASE == 1) {
            (findViewById(R.id.divider_toolbar)).setVisibility(View.GONE);
        ...
        // TODO
        /**
         * #Case 1 - Get URL from bundle, when we open app in web view
         */
        if (bundle != null && bundle.getString("key_url") != null) {
            ...
            url = CustomConfiguration.URL_APPLICATION;
        }
        ...
        if (savedInstanceState == null) {
            EventLogger.logError(getClass(), "Start WebPage");
            cordovaWebView.loadUrl(url);
            //cordovaWebView.loadUrl("file:///android_asset/www/index.html");
        } else {
            ((RelativeLayout) findViewById(R.id.view_loading)).setVisibility(View.GONE);
        }
        ...
        // TODO
        /**
         * Case 1 - Hide Button Application Case 2 - Hide Button Application Case 3 - Hide Button Application
         *
         */
        // buttonApplications.setVisibility(View.GONE);
        // TODO
        /**
         * Case 1 - Hide Toolbar Case 2 - Hide ToolBar Case 3 - Hide ToolBar
         */
        (findViewById(R.id.divider_toolbar)).setVisibility(View.GONE);
        View viewToolbar = findViewById(R.id.toolbar);
        viewToolbar.setVisibility(View.GONE);
        ...
        ((Button) findViewById(R.id.button_try_again)).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                cordovaWebView.setBackgroundColor(Color.WHITE);
                cordovaWebView.loadUrl(urlToReload);
                cordovaWebView.setVisibility(View.INVISIBLE);
                startLoadingAnimation();

                if ((findViewById(R.id.view_error)).getVisibility() == View.VISIBLE) {
        ...
        cordovaWebView.getSettings().setAppCacheMaxSize(1024*1024*8);

        // This next one is crazy. It's the DEFAULT location for your app's cache
        // But it didn't work for me without this line
        cordovaWebView.getSettings().setAppCachePath("/data/data/"+ getPackageName() +"/cache");
    ...
    public class CordovaCustomWebClient extends CordovaLoaderWebClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            startLoadingAnimation();
            EventLogger.logError("PAGELOAD","started " +  url);
            return super.shouldOverrideUrlLoading(view, url);
        }
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            EventLogger.logError("PAGELOAD","finished " +  url);
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            ...
            if (cm.getActiveNetworkInfo() != null && cm.getActiveNetworkInfo().isConnectedOrConnecting()) {
                ...
                urlToReload = cordovaWebView.getUrl();
                cordovaWebView.setVisibility(View.INVISIBLE);
                String customErrorPageHtml = "<html><head></head><body style=\"background-color:white;\"></body></html>";
                cordovaWebView.loadData(customErrorPageHtml, "text/html", null);
                imageView.setVisibility(View.VISIBLE);
    ...
    public void spinnerStart() {
        flagNumberLoadings++;
        EventLogger.logError("SUPERCLASS","----> SPINNER START " + flagNumberLoadings);
        RelativeLayout viewLoading = (RelativeLayout) findViewById(R.id.view_loading);

        ImageView loadingImage = (ImageView) findViewById(R.id.imageLoading);
        if (loadingImage.getVisibility() != View.VISIBLE) {
            ...
            loadingImage.startAnimation(AnimationUtils.loadAnimation(getApplicationContext(), R.anim.rotate_indefinitely));
        }
        if (viewLoading.getVisibility() != View.VISIBLE) {
    ...
    public void spinnerStop() {
        ...
        EventLogger.logError("SUPERCLASS","----> SPINNER STOP " + flagNumberLoadings);
        ...
        if (viewLoading.getVisibility() == View.VISIBLE) {
            ...
            EventLogger.logError("SUPERCLASS","----> HIDE SPINNER " + flagNumberLoadings);
        }
        flagNumberLoadings--;
    }
